...
** TODO As a developer i want to implement command design pattern
- [ ] implement command design pattern for quitting the editor
- [ ] implement command design pattern for open file
- [ ] implement command design pattern for save file
- [ ] implement command design pattern for quitting minibuffer operations(ex save file)
